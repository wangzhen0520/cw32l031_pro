...
/**
  ...
  * @retval HAL status
  */
__attribute__ ((weak))  void InitTick(uint32_t HclkFreq)
{
...
/**
  ...
  * @retval None
  */
__attribute__ ((weak))  void SysTickDelay(uint32_t Delay)
{
...
/**
  ...
  * @retval None
  */
__attribute__ ((weak))  void SuspendTick(void)
...
/**
  ...
  * @retval None
  */
__attribute__ ((weak))  void ResumeTick(void)
{
